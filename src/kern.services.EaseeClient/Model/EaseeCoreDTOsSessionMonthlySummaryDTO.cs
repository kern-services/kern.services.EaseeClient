...
{
    /// <summary>
    /// EaseeCoreDTOsSessionMonthlySummaryDTO
    /// </summary>
    [DataContract(Name = "Easee.Core.DTOs.Session.MonthlySummaryDTO")]
    public partial class EaseeCoreDTOsSessionMonthlySummaryDTO : IEquatable<EaseeCoreDTOsSessionMonthlySummaryDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EaseeCoreDTOsSessionMonthlySummaryDTO" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EaseeCoreDTOsSessionMonthlySummaryDTO {\n");
        ...
        {
            return this.Equals(input as EaseeCoreDTOsSessionMonthlySummaryDTO);
        }

        /// <summary>
        /// Returns true if EaseeCoreDTOsSessionMonthlySummaryDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of EaseeCoreDTOsSessionMonthlySummaryDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EaseeCoreDTOsSessionMonthlySummaryDTO input)
        {
            if (input == null)
            {
                return false;
