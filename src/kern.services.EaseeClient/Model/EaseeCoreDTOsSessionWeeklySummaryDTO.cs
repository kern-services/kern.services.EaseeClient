...
{
    /// <summary>
    /// EaseeCoreDTOsSessionWeeklySummaryDTO
    /// </summary>
    [DataContract(Name = "Easee.Core.DTOs.Session.WeeklySummaryDTO")]
    public partial class EaseeCoreDTOsSessionWeeklySummaryDTO : IEquatable<EaseeCoreDTOsSessionWeeklySummaryDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EaseeCoreDTOsSessionWeeklySummaryDTO" /> class.
        /// </summary>
        ...
        public EaseeCoreDTOsSessionWeeklySummaryDTO(int year = default(int), int month = default(int), int weekOfYear = default(int), double totalEnergyUsage = default(double), double totalCost = default(double), string currencyId = default(string), List<EaseeCoreDTOsSessionAuthorizationTokenEnergy> authTokensUsage = default(List<EaseeCoreDTOsSessionAuthorizationTokenEnergy>))
        {
            this.Year = year;
            this.Month = month;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EaseeCoreDTOsSessionWeeklySummaryDTO {\n");
        ...
        {
            return this.Equals(input as EaseeCoreDTOsSessionWeeklySummaryDTO);
        }

        /// <summary>
        /// Returns true if EaseeCoreDTOsSessionWeeklySummaryDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of EaseeCoreDTOsSessionWeeklySummaryDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EaseeCoreDTOsSessionWeeklySummaryDTO input)
        {
            if (input == null)
            {
                return false;
