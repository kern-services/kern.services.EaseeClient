...
{
    /// <summary>
    /// EaseeCoreDTOsSiteSiteDTO
    /// </summary>
    [DataContract(Name = "Easee.Core.DTOs.Site.SiteDTO")]
    public partial class EaseeCoreDTOsSiteSiteDTO : IEquatable<EaseeCoreDTOsSiteSiteDTO>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EaseeCoreDTOsSiteSiteDTO" /> class.
        /// </summary>
        ...
        public EaseeCoreDTOsSiteSiteDTO(int id = default(int), string siteKey = default(string), string name = default(string), EaseeCoreEnumsLevelOfAccess? levelOfAccess = default(EaseeCoreEnumsLevelOfAccess?), EaseeCoreDTOsSiteAddressDTO address = default(EaseeCoreDTOsSiteAddressDTO), EaseeCoreDTOsSiteContactInfoDTO contactInfo = default(EaseeCoreDTOsSiteContactInfoDTO), double? costPerKWh = default(double?), double costPerKwhExcludeVat = default(double), double? vat = default(double?), string currencyId = default(string), EaseeCoreConstantsProductType? siteType = default(EaseeCoreConstantsProductType?), double ratedCurrent = default(double), int? partnerId = default(int?), int? ownerPartnerId = default(int?), bool useDynamicMaster = default(bool), List<EaseeCoreDTOsSiteCircuitDTO> circuits = default(List<EaseeCoreDTOsSiteCircuitDTO>), List<EaseeCoreDTOsEqualizerEqualizerDTO> equalizers = default(List<EaseeCoreDTOsEqualizerEqualizerDTO>), DateTime createdOn = default(DateTime), DateTime updatedOn = default(DateTime))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EaseeCoreDTOsSiteSiteDTO {\n");
        ...
        {
            return this.Equals(input as EaseeCoreDTOsSiteSiteDTO);
        }

        /// <summary>
        /// Returns true if EaseeCoreDTOsSiteSiteDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of EaseeCoreDTOsSiteSiteDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EaseeCoreDTOsSiteSiteDTO input)
        {
            if (input == null)
            {
                return false;
